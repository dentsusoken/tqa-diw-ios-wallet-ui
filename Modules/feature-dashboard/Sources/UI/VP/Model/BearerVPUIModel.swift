...
public struct BearerVPUIModel: Identifiable, Equatable {
...
public extension BearerVPUIModel {
  ...
  static func mock() -> BearerVPUIModel {
    .init(
      id: UUID().uuidString,
      value: .init(
        name: "",
  ...
  static func transformToBearerUi(
    ...
    let storageDocuments = walletKitController.fetchDocuments(
      excluded: [DocumentTypeIdentifier.MDL]
    )
